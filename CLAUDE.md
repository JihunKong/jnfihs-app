...
- **AI**: Claude API (@anthropic-ai/sdk) for chatbot and translation
- **Icons**: lucide-react
...
│   ├── chat/           # AI chatbot
│   ├── regulations/    # Student regulations viewer
│   ├── broadcast/      # Teacher: real-time translation input
│   └── listen/         # Student: receive translated subtitles
...
lib/                   # Utilities (claude.ts, regulations.ts)
...
- Claude API responses include the student regulations context for accurate answers
